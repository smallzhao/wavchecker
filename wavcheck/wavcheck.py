...
image_map = {
    'checknoise': 'registry.cn-beijing.aliyuncs.com/shujutang/checknoise:v0.10.0',
    'energydet': '',
    'mandarin-asr': 'registry.cn-beijing.aliyuncs.com/shujutang/mandarin-asr:v0.3'
}
...
if __name__ == '__main__':
    ...
    parser.add_argument('--filter', type=str, required=True, default='mandarin-asr', choices=image_map.keys(), help='选择检测器')
